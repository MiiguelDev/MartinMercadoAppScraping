...
class CustomDialog(tk.Toplevel):
    def __init__(self, parent, title, message):
        ...
        self.iconbitmap('images/bird-1.ico')
...
def mostrar_menu_principal():
    ...
    imagen_redimensionada = cargar_y_redimensionar_imagen('images/bird-1.png', 100, 100)
...
def mostrar_pantalla_pre_inicio(app):
    ...
    original_img = Image.open("images/martin1.jpg")
...
if __name__ == "__main__":  
    ...
    icon = PhotoImage(file='static/assets/favicon-32x32.png')
